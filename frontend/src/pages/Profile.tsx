  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        /> 
        <img
          src={currentUser && currentUser.profilePicture ? currentUser.profilePicture : formData.profilePicture}
          alt='profile'
        ...
        />
        <input
          defaultValue={currentUser && currentUser?.email ? currentUser?.email : formData?.email}
          type='email'
          id='email'
          placeholder='Email'
          className='bg-slate-100 rounded-lg p-3'
